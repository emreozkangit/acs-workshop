...
[#integration_demo_ocp_pipelines_roxctl]
=== Use Roxctl Tool
...
Let's download Roxctl Tool to check and scan some images. 

. Login your terminal and Download the latest version of the roxctl CLI:
+
[.console-input]
[source,bash,subs="attributes+,+macros"]	
----	
curl -O https://mirror.openshift.com/pub/rhacs/assets/3.69.1/bin/Linux/roxctl
----
...
[#integration_demo_ocp_pipelines_tkn_cli]
=== Use Tekton Pipelines CLI
