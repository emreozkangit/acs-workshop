...
. Click ``Next`` 
. ACS comes some default policy criteria with different categories. ``Image Registry`` , ``Image Contents`` Let's lookup this criterias.You can drag and drop these criterias
+
image::policies/14-policies.png[ACS Policies 14, 900]
+
